                ...
                <div className='create-listing_step1'>
                    ...
                    <div className='half'>
                        <div className='location'>
                            ...
                            <input type="text" name="aptSuite" placeholder='Apt, Suite, etc. (if applicable)' value={formLocation.aptSuite} onChange={handleChangeLocation}  required />
                        </div>
                        <div className='location'>
                            <p>City</p>
                            <input type="text" name="city" placeholder='City' value={formLocation.city} onChange={handleChangeLocation}  required/>
                        </div>
                    </div>
                    ...
                    <div className='half'>
                        <div className='location'>
                            <p>Province</p>
                            <input type="text" name="province" placeholder='Province' value={formLocation.province} onChange={handleChangeLocation}  required />
                        </div>
                        <div className='location'>
                            <p>Country</p>
                            <input type="text" name="country" placeholder='Country' value={formLocation.country} onChange={handleChangeLocation}  required/>
                        </div>
                    </div>
